...
model name, the messages, the JSON schema and the decoding options - plus the
server's KV cache precision, which shapes the answer without being sent. That makes
